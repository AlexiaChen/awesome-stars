...
- [mnemocron/STM32-Tutorial](https://github.com/mnemocron/STM32-Tutorial) – Getting started with the STM32 HAL development environment. Tutorial documents in Markdown. 
...
- [yohanes-erwin/stm32f103-keil](https://github.com/yohanes-erwin/stm32f103-keil) – Programming STM32F013 (Blue Pill) by Examples (SPL)
- [cnoviello/mastering-stm32](https://github.com/cnoviello/mastering-stm32) – Repository of all examples presented in the "Mastering STM32" book
...
- [avislab/STM32F103](https://github.com/avislab/STM32F103) – STM32F103C8 Examples
- [MaJerle/stm32f429](https://github.com/MaJerle/stm32f429) – Keil projects and libraries for STM32F4xx devices
- [robots/STM32](https://github.com/robots/STM32) – Various Cortex-M3 projects
...
- [pelikan-io/pelikan](https://github.com/pelikan-io/pelikan) – Pelikan is a framework for building local or distributed caches. It comes with a highly extensible architecture, best-in-class performance, and superb operational ergonomics. You can use it to replace most of Memcached or a subset of Redis features.
...
- [zl03jsj/mupdf](https://github.com/zl03jsj/mupdf) – 扩展mupdf 实现图像数字证书签名, 手写笔迹数字证书签名, 插入图片, 手写签名注释..改进手写批注,实现模拟真实手写的算法, annot自定义数据, annot插入,删除密码校验等功能...支持ios, windows, mac, linux, c++, java, android
...
- [NewChromantics/PopH264](https://github.com/NewChromantics/PopH264) – Low-level, minimal H264 decoder & encoder library for windows, hololens/uwp, ios/tvos/macos, linux, android/quest/magic leap. CAPI for use with c#, unreal, swift
- [BlockstreamResearch/secp256k1-zkp](https://github.com/BlockstreamResearch/secp256k1-zkp) – A fork of libsecp256k1 with support for advanced and experimental features such as Confidential Assets and MuSig2
...
- [LeoVen/C-Macro-Collections](https://github.com/LeoVen/C-Macro-Collections) – Easy to use, modular, header only, macro based, generic and type-safe Data Structures in C
...
- [OpenGammaProject/Open-Gamma-Detector](https://github.com/OpenGammaProject/Open-Gamma-Detector) – ☢️👁️ Hardware for a hackable DIY gamma-ray spectrometer using a popular NaI(Tl) scintillator, SiPM and a Raspberry Pi Pico.
...
- [earthrover/OpenER](https://github.com/earthrover/OpenER) – OpenER an Open Source ROS robot with mechanical design.
...
- [PacktPublishing/Vulkan-Cookbook](https://github.com/PacktPublishing/Vulkan-Cookbook) – Code repository for Vulkan Cookbook by Packt
...
- [harrisonvanderbyl/rwkv-cpp-accelerated](https://github.com/harrisonvanderbyl/rwkv-cpp-accelerated) – A torchless, c++ rwkv implementation using 8bit quantization, written in cuda/hip/vulkan for maximum compatibility and minimum dependencies
...
- [Safeheron/multi-party-sig-cpp](https://github.com/Safeheron/multi-party-sig-cpp) – This project is a C++ implementation of {t,n}-Threshold Signature Scheme
...
- [primihub/hehub](https://github.com/primihub/hehub) – HEhub is a library for homomorphic encryption and its applications, and is part of the PrimiHub project.
...
- [FudanMPL/SecMML](https://github.com/FudanMPL/SecMML) – SecMML (Queqiao): Secure MPC (multi-party computation) Machine Learning Framework.
...
- [eraft-io/eraft](https://github.com/eraft-io/eraft) – A generic raft library
...
- [Chia-Network/bls-signatures](https://github.com/Chia-Network/bls-signatures) – BLS signatures in C++, using the blst library for BLS12-381
...
- [AztecProtocol/aztec-2.0](https://github.com/AztecProtocol/aztec-2.0) – C++ elliptic curve library
...
- [skalenetwork/skale-consensus](https://github.com/skalenetwork/skale-consensus) – Running the very core of SKL network, SKALE BFT consensus is universal, modern, modular, high-performance, asynchronous, provably-secure, agent-based Proof-of-Stake blockchain consensus engine in C++ 17. Includes provably secure embedded Oracle.   Used by SKALE elastic blockchains.  Easy and flexible enough to implement your own blockchain or smart contract platform. BLS signatures and Binary Asynchronous Consensus are main building blocks. 
...
- [y1yang0/yvm](https://github.com/y1yang0/yvm) – [yvm] low performance garbage-collectable jvm
...
- [Qihoo360/nemo](https://github.com/Qihoo360/nemo) – A library that provide multiply data structure. Such as map, hash, list, set. We build these data structure base on rocksdb as the storage layer for Pika https://github.com/OpenAtomFoundation/pika .
...
- [Carbonable/carbon-protocol](https://github.com/Carbonable/carbon-protocol) – Carbon Starknet Protocol written in Cairo.
- [starkoracles/Aero](https://github.com/starkoracles/Aero) – A blazingly fast sdk for running proofs on the browser... and verifying them on-chain
...
- [erhant/zkbrainfuck](https://github.com/erhant/zkbrainfuck) – A Brainfuck zkVM with Circom.
- [bankisan/zkShield](https://github.com/bankisan/zkShield) – Private multisig with hidden owners
...
- [ingonyama-zk/cuda-field-expts](https://github.com/ingonyama-zk/cuda-field-expts) – Simple modular mult for mersene prime in CUDA
...
- [openimsdk/open-im-sdk-flutter](https://github.com/openimsdk/open-im-sdk-flutter) – IM SDK Flutter
- [openimsdk/open-im-flutter-demo](https://github.com/openimsdk/open-im-flutter-demo) – Demo developed based on flutter open IM SDK.
...
- [nitram509/lib-bpmn-engine](https://github.com/nitram509/lib-bpmn-engine) – A BPMN engine, meant to be embedded in Go applications with minimal hurdles, and a pleasant developer experience using it. This approach can increase transparency for non-developers.
...
- [morkid/paginate](https://github.com/morkid/paginate) – paginate - Gorm Pagination Library
...
- [trstringer/otel-shopping-cart](https://github.com/trstringer/otel-shopping-cart) – Sample application illustrating multiple aspects of observability with OpenTelemetry
...
- [NethermindEth/cairo-vm-go](https://github.com/NethermindEth/cairo-vm-go) – A virtual machine for Cairo written in Go
...
- [taurusgroup/multi-party-sig](https://github.com/taurusgroup/multi-party-sig) – Implementation of protocols for threshold signatures
...
- [Arachnid/evmdis](https://github.com/Arachnid/evmdis) – EVM disassembler
...
- [pilinux/gorest](https://github.com/pilinux/gorest) – Go RESTful API starter kit with Gin, JWT, GORM (MySQL, PostgreSQL, SQLite), Redis, Mongo, 2FA, email verification, password recovery
...
- [keyfuse/tokucore](https://github.com/keyfuse/tokucore) –  A Simple, Powerful, Modular Library for Bitcoin Blockchain As a Service(BAAS)
...
- [ChainSafe/go-schnorrkel](https://github.com/ChainSafe/go-schnorrkel) – 🍵 Schnorr Signatures over Ristretto255 in pure Go
...
- [zhangchiqing/merkle-patricia-trie](https://github.com/zhangchiqing/merkle-patricia-trie) – A simplified golang implementation of Ethereum's Modified Patricia Trie.
...
- [ChainSafe/gossamer](https://github.com/ChainSafe/gossamer) – 🕸️ Go Implementation of the Polkadot Host
...
- [Onyx-Protocol/Onyx](https://github.com/Onyx-Protocol/Onyx) – Onyx
...
- [vasedb/vasedb](https://github.com/vasedb/vasedb) – VaseDB is a NoSQL that supports multiple data types and transactions.
...
- [AliyunContainerService/derrick](https://github.com/AliyunContainerService/derrick) – 🐳A tool to help you containerize application in seconds
...
- [mRoboticsIO/Blimpduino2](https://github.com/mRoboticsIO/Blimpduino2) – Arduino and Android Apps for Blimpduino
...
- [ProgrammerAnthony/RocketMQC](https://github.com/ProgrammerAnthony/RocketMQC) – RocketMQ添加源码学习笔记和思维导图等
...
- [sengeiou/ZTuoExchange_framework](https://github.com/sengeiou/ZTuoExchange_framework) – 数字币JAVA交易所框架
...
- [xipki/xipki](https://github.com/xipki/xipki) – Compact open source PKI (CA, OCSP responder, certificate protocols ACME, CMP, EST, SCEP) with HSM support.
...
- [eclipse-birt/birt](https://github.com/eclipse-birt/birt) – Eclipse BIRT™ The open source reporting and data visualization project. 
...
- [hathamneh/MicroCompiler](https://github.com/hathamneh/MicroCompiler) – A very tiny compiler for Micro language
...
- [bpmnServer/bpmn-server](https://github.com/bpmnServer/bpmn-server) – BPMN 2.0 server for Node.js , providing modeling, execution, persistence and monitoring for Workflow. along with sample UI. Intended to be developers workbench for BPMN 2.0
...
- [paulmillr/scure-btc-signer](https://github.com/paulmillr/scure-btc-signer) – Audited & minimal library for creating, signing & decoding Bitcoin transactions.
- [paulmillr/scure-starknet](https://github.com/paulmillr/scure-starknet) – Audited & minimal JS implementation of Starknet cryptography.
...
- [gemini-testing/looks-same](https://github.com/gemini-testing/looks-same) – Node.js library for comparing images
...
- [ZenGo-X/ShareLock](https://github.com/ZenGo-X/ShareLock) – ShareLock: mixing for cryptocurrencies from multiparty ECDSA
...
- [sc-forks/solidity-coverage](https://github.com/sc-forks/solidity-coverage) – Code coverage for Solidity smart-contracts 
...
- [liquity/dev](https://github.com/liquity/dev) – Liquity monorepo containing the contracts, SDK and Dev UI frontend.
- [lidofinance/lido-dao](https://github.com/lidofinance/lido-dao) – Lido DAO smart contracts
...
- [ChainSafe/chainbridge-solidity](https://github.com/ChainSafe/chainbridge-solidity) – ⚙️ Solidity contracts for Sygma (ChainBridge)
...
- [architect/dynalite](https://github.com/architect/dynalite) – An implementation of Amazon's DynamoDB built on LevelDB
...
- [zhuweiyou/weixin-game-helper](https://github.com/zhuweiyou/weixin-game-helper) – 微信小游戏辅助合集（加减大师、包你懂我、大家来找茬腾讯版、头脑王者、好友画我、悦动音符、我最在行、星途WeGoing、猜画小歌、知乎答题王、腾讯中国象棋、跳一跳、题多多黄金版）
...
- [xsf0105/react-redux-tutorial](https://github.com/xsf0105/react-redux-tutorial) – Starter template for React v17, Redux, CSS Modules, React-Router 4
...
- [baidu/puck](https://github.com/baidu/puck) – Puck is a high-performance ANN search engine
- [SHI-Labs/OneFormer](https://github.com/SHI-Labs/OneFormer) – [CVPR 2023] OneFormer: One Transformer to Rule Universal Image Segmentation
...
- [huangjia2019/geektime](https://github.com/huangjia2019/geektime) – Machine Learning from Scratch
...
- [MuhammadMoinFaisal/YOLOv8_Segmentation_DeepSORT_Object_Tracking](https://github.com/MuhammadMoinFaisal/YOLOv8_Segmentation_DeepSORT_Object_Tracking) – YOLOv8 Segmentation with DeepSORT Object Tracking (ID + Trails)
...
- [eric-ai-lab/photoswap](https://github.com/eric-ai-lab/photoswap) – Official implementation of the NeurIPS 2023 paper "Photoswap: Personalized Subject Swapping in Images"
...
- [VikParuchuri/zero_to_gpt](https://github.com/VikParuchuri/zero_to_gpt) – Go from no deep learning knowledge to implementing GPT.
...
- [lambdaclass/STARK101-rs](https://github.com/lambdaclass/STARK101-rs) – STARK 101 Workshop in Rust 🐺🦀
- [amusi/TensorFlow-From-Zero-To-One](https://github.com/amusi/TensorFlow-From-Zero-To-One) – TensorFlow 最佳学习资源大全（含课程、书籍、博客、公开课等内容）
...
- [luwill/Machine_Learning_Code_Implementation](https://github.com/luwill/Machine_Learning_Code_Implementation) – Mathematical derivation and pure Python code implementation of machine learning algorithms.
...
- [bytedance/btrace](https://github.com/bytedance/btrace) – 🔥🔥 btrace(AKA RheaTrace) is a high performance Android trace tool which is based on Perfetto, it support to define custom events automatically during building apk and using bhook to provider more native events like Render/Binder/IO etc.
- [gedoor/legado](https://github.com/gedoor/legado) – Legado 3.0 Book Reader with powerful controls & full functions❤️阅读3.0, 阅读是一款可以自定义来源阅读网络内容的工具，为广大网络文学爱好者提供一种方便、快捷舒适的试读体验。
- [0gajun/StoneLanguage](https://github.com/0gajun/StoneLanguage) – Creating Stone Language introduced by this book(http://gihyo.jp/book/2012/978-4-7741-4974-5)
...
- [anruence/enode](https://github.com/anruence/enode) – DDD 框架
...
- [FindMyCat/engineering-docs](https://github.com/FindMyCat/engineering-docs) – Engineering Documentation for FindMyCat
...
- [slurm-personal/school-dev-k8s](https://github.com/slurm-personal/school-dev-k8s)

<div id="nim"></div>

## Nim

- [mratsim/constantine](https://github.com/mratsim/constantine) – Constantine: high-performance cryptography for proof systems and blockchain protocols.
...
- [o1-labs/snarky](https://github.com/o1-labs/snarky) – OCaml DSL for verifiable computation
...
- [bpmn-io/awesome-bpmn-io](https://github.com/bpmn-io/awesome-bpmn-io) – A curated list of bpmn.io related projects and resources. 
- [LinDaiDai/bpmn-chinese-document](https://github.com/LinDaiDai/bpmn-chinese-document) – 📒  全网最详bpmn.js中文教材/文档
- [JGAguado/Smart_Plant](https://github.com/JGAguado/Smart_Plant) – The Smart Plant is a board that can be plugged directly on the soil, close to the plant, that allows the measurement of the environment (soil moisture, environment temperature & illuminance), and presents the information on an ePaper display.
...
- [WeOps-Lab/topology-scanner](https://github.com/WeOps-Lab/topology-scanner) – 网络拓扑自动扫描工具
...
- [mathllm/MathCoder](https://github.com/mathllm/MathCoder) – Family of LLMs for mathematical reasoning.
- [teivah/sre-roadmap](https://github.com/teivah/sre-roadmap) – An Opinionated Roadmap to Become an SRE (Concepts > Tools)
- [pado-labs/awesome-izk](https://github.com/pado-labs/awesome-izk) – Created for Web3 builders
...
- [Quillhash/Web3-Security-Tools](https://github.com/Quillhash/Web3-Security-Tools) – This repository contains a list of the most popular and widely used tools in web3 security. If you find any tools missing, you can create a pull request and be a contribute the project.
...
- [vicuna-tools/vicuna-installation-guide](https://github.com/vicuna-tools/vicuna-installation-guide) – The "vicuna-installation-guide" provides step-by-step instructions for installing and configuring Vicuna 13 and 7B
...
- [zkcrypto/groth16](https://github.com/zkcrypto/groth16) – Implementation of the Groth16 zk-SNARK proving system
...
- [flashbots/mev-research](https://github.com/flashbots/mev-research) – Project management for MEV Research
...
- [refcell/optimism-rs](https://github.com/refcell/optimism-rs) – Scaling Ethereum, but this time in rust.
...
- [zisequkuai/zk](https://github.com/zisequkuai/zk) – zk Library
...
- [Sin7Y/consenSys-zkevm-whitepaper-chinese](https://github.com/Sin7Y/consenSys-zkevm-whitepaper-chinese)
...
- [cmluZw/Situational-Awareness](https://github.com/cmluZw/Situational-Awareness) – 态势感知系统
...
- [Ensoul-Labs/awesome-soulbound-tokens](https://github.com/Ensoul-Labs/awesome-soulbound-tokens) – A curated list of awesome things related to Soulbound Tokens(SBTs).
- [attestate/awesome-soulbound-tokens](https://github.com/attestate/awesome-soulbound-tokens) – A curated list of links related to Soulbound tokens.
...
- [pickle-finance/contracts](https://github.com/pickle-finance/contracts) – Deployed contracts
...
- [Text-to-Audio/Make-An-Audio](https://github.com/Text-to-Audio/Make-An-Audio)
- [wagiminator/ATtiny412-PocketRadio](https://github.com/wagiminator/ATtiny412-PocketRadio) – Small FM Radio with RDS and OLED
- [seawarrior181/PasswordPump_II](https://github.com/seawarrior181/PasswordPump_II) – Version 2 of the PasswordPump, for the ItsyBitsy M0 & ItsyBitsy M4.
- [Python-IoT/Smart-IoT-Planting-System](https://github.com/Python-IoT/Smart-IoT-Planting-System) – Smart IoT Planting System is a intelligence planting project consist of sensors,actuator,LoRa,gateway,cloud.
...
- [hkchengrex/Cutie](https://github.com/hkchengrex/Cutie) – [arXiv 2023] Putting the Object Back Into Video Object Segmentation
...
- [dog-qiuqiu/FastestDet](https://github.com/dog-qiuqiu/FastestDet) – :zap: A newly designed ultra lightweight anchor free target detection algorithm， weight only 250K parameters， reduces the time consumption by 10% compared with yolo-fastest, and the post-processing is simpler
...
- [huangjia2019/geektime_chatgpt](https://github.com/huangjia2019/geektime_chatgpt)
- [huangjia2019/langchain](https://github.com/huangjia2019/langchain) – LangChain实战课
...
- [cpplint/cpplint](https://github.com/cpplint/cpplint) – Static code checker for C++
...
- [chaoyi-wu/PMC-LLaMA](https://github.com/chaoyi-wu/PMC-LLaMA) – The official codes for "PMC-LLaMA: Towards Building Open-source Language Models for Medicine"
...
- [breezedeus/CnOCR](https://github.com/breezedeus/CnOCR) – CnOCR: Awesome Chinese/English OCR toolkits based on PyTorch/MXNet, It comes with 20+ well-trained models for different application scenarios and can be used directly after installation. 【基于 PyTorch/MXNet 的中文/英文 OCR Python 包。】
...
- [blockchain-etl/polygon-etl](https://github.com/blockchain-etl/polygon-etl) – ETL (extract, transform and load) tools for ingesting Polygon blockchain data to Google BigQuery and Pub/Sub
- [blockchain-etl/bitcoin-etl](https://github.com/blockchain-etl/bitcoin-etl) – ETL scripts for Bitcoin, Litecoin, Dash, Zcash, Doge, Bitcoin Cash. Available in Google BigQuery https://goo.gl/oY5BCQ
...
- [YuliangXiu/ECON](https://github.com/YuliangXiu/ECON) – [CVPR'23, Highlight] ECON: Explicit Clothed humans Optimized via Normal integration
...
- [FuzzingLabs/thoth](https://github.com/FuzzingLabs/thoth) – Cairo/Starknet security toolkit (bytecode analyzer, disassembler, decompiler, symbolic execution, SBMC)
...
- [SCIR-HI/Med-ChatGLM](https://github.com/SCIR-HI/Med-ChatGLM) – Repo for Chinese Medical ChatGLM 基于中文医学知识的ChatGLM指令微调
...
- [ngmisl/CSV-Agent-Q_n_A](https://github.com/ngmisl/CSV-Agent-Q_n_A) – Question and Answer for CSV using langchain and OpenAI
...
- [sangmichaelxie/cs324_p2](https://github.com/sangmichaelxie/cs324_p2) – Project 2 (Building Large Language Models) for Stanford CS324: Understanding and Developing Large Language Models (Winter 2022)
...
- [scroll-tech/zkevm-specs](https://github.com/scroll-tech/zkevm-specs)
...
- [JoranHonig/vertigo](https://github.com/JoranHonig/vertigo) – Mutation Testing for Ethereum Smart Contracts
...
- [yearn/yearn-vaults](https://github.com/yearn/yearn-vaults) – Yearn Vault smart contracts
- [curvefi/curve-contract](https://github.com/curvefi/curve-contract) – Vyper contracts used in Curve.fi exchange pools.
...
- [cloveropen/pass](https://github.com/cloveropen/pass) – 临床合理用药监测系统(prescription automatic screening system PASS)是一套供医生、药师等医疗专业人员从事医嘱及时性监测、药物信息查询、病人用药教育等临床药学工作的药物数据库软件系统。它可以对每条用药医嘱可能存在的潜在不合理用药问题进行及时性监测, 监测结果以黑、红、黄、绿不同警示色的方式显示在每一条医嘱前, 医生和药师根据提示对医嘱进行必要的修改和技术干预。从而使合理用药监测走向制度化、规范化。
- [hualuoo/dormitory_menage_system](https://github.com/hualuoo/dormitory_menage_system) – 基于人脸识别的门禁管理系统(Python+Django+RESTframework+JsonWebToken)
...
- [PINTO0309/wsl2_linux_kernel_usbcam_enable_conf](https://github.com/PINTO0309/wsl2_linux_kernel_usbcam_enable_conf) – Configuration file to build the kernel to access the USB camera connected to the host PC using USBIP from inside the WSL2 Ubuntu 20.04/22.04.
...
- [nexB/scancode-toolkit](https://github.com/nexB/scancode-toolkit) – :mag: ScanCode detects licenses, copyrights, dependencies by "scanning code" ... to discover and inventory open source and third-party packages used in your code. Sponsored by NLnet project https://nlnet.nl/project/vulnerabilitydatabase, the Google Summer of Code, Azure credits, nexB and others generous sponsors!
...
- [marvin-j97/lsm-tree](https://github.com/marvin-j97/lsm-tree) – K.I.S.S. LSM-trees in safe Rust
...
- [snarkify/sirius](https://github.com/snarkify/sirius) – A folding framework for Incrementally Verifiable Computation (IVC).
- [hashcloak/fhe_risc0_zkvm](https://github.com/hashcloak/fhe_risc0_zkvm) – FHE in the Risc0 zkVM
- [vaibhawvipul/minimal-raft](https://github.com/vaibhawvipul/minimal-raft) – a minimalistic implementation of RAFT algorithm
...
- [Conflux-Chain/conflux-rust](https://github.com/Conflux-Chain/conflux-rust) – The official Rust implementation of Conflux protocol. https://doc.confluxnetwork.org
...
- [nrxus/faux](https://github.com/nrxus/faux) – Struct mocking library for Rust
...
- [erhant/halo2-vectordb](https://github.com/erhant/halo2-vectordb) – Verifiable vector similarity queries with Halo2. (work in progress)
...
- [Plonky3/Plonky3](https://github.com/Plonky3/Plonky3) – A collection of libraries related to polynomial IOPs (PIOPs)
- [paritytech/polkadot-sdk](https://github.com/paritytech/polkadot-sdk) – The Parity Polkadot Blockchain SDK
- [tisonkun/kafka-api](https://github.com/tisonkun/kafka-api) – Generic abstractions for Kafka API.
- [emmett-framework/granian](https://github.com/emmett-framework/granian) – A Rust HTTP server for Python applications
- [xetdata/nfsserve](https://github.com/xetdata/nfsserve) – A Rust NFS Server implementation
- [pasindumuth/rUniversalDB](https://github.com/pasindumuth/rUniversalDB)
...
- [rainshowerLabs/blutgang](https://github.com/rainshowerLabs/blutgang) – the wd40 of ethereum load balancers
...
- [xJonathanLEI/oriac](https://github.com/xJonathanLEI/oriac) – A toy Cairo VM implementation in Rust™
...
- [lun3x/multi_index_map](https://github.com/lun3x/multi_index_map) – Simple and flexible multi-index containers.
...
- [jpopesculian/ed25519-dalek-bip32](https://github.com/jpopesculian/ed25519-dalek-bip32) – Simplified ed25519 BIP32 derivations
- [arnaucube/poseidon-rs](https://github.com/arnaucube/poseidon-rs) – Poseidon hash function
...
- [paritytech/libsecp256k1](https://github.com/paritytech/libsecp256k1) – Pure Rust Implementation of secp256k1.
...
- [arnaucube/fri-commitment](https://github.com/arnaucube/fri-commitment) – FRI low-degree-testing & polynomial commitment scheme
...
- [primitivefinance/arbiter](https://github.com/primitivefinance/arbiter) – Allowing smart contract developers to do simulation driven development via an EVM emulator.
...
- [lambdaclass/starknet_tendermint_sequencer](https://github.com/lambdaclass/starknet_tendermint_sequencer) – Starknet sequencer built with Tendermint Core
...
- [Sin7Y/olavm](https://github.com/Sin7Y/olavm) – A STARK-based ZKVM which aims to Programmable Scalability, Programmable Privacy 
- [ZenGo-X/multi-hop-locks](https://github.com/ZenGo-X/multi-hop-locks) – ECDSA based construction for Anonymous Multi-Hop Locks (https://eprint.iacr.org/2018/472.pdf)
...
- [personaelabs/spartan-ecdsa](https://github.com/personaelabs/spartan-ecdsa) – The fastest in-browser verification of ECDSA signatures in ZK, using Spartan on the secq256k1 curve
- [cronokirby/cait-sith](https://github.com/cronokirby/cait-sith) – Threshold ECDSA via Triples
- [0xPolygonZero/r1cs](https://github.com/0xPolygonZero/r1cs) – A Rust library for building R1CS gadgets
...
- [nag763/texas-snake](https://github.com/nag763/texas-snake) – A simple 2D snake game built with Bevy and WASM
- [flo-at/rustsnake](https://github.com/flo-at/rustsnake) – Terminal-based Snake game written in Rust without dependencies (for educational purposes).
...
- [risc0/risc0-rust-examples](https://github.com/risc0/risc0-rust-examples) – These RISC Zero examples have been moved to the main risc0/risc0 repository
...
- [jstnlef/rustris](https://github.com/jstnlef/rustris) – An implementation of Tetris written in Rust.
...
- [ing-bank/threshold-signatures](https://github.com/ing-bank/threshold-signatures) – Threshold Signature Scheme for ECDSA
...
- [PaulRBerg/multisol](https://github.com/PaulRBerg/multisol) – CLI application for verifying Solidity contracts on Etherscan
...
- [timoftime/zk-timelock](https://github.com/timoftime/zk-timelock) – Arkworks circuits for verifiable time-lock encryption
...
- [ros2-rust/ros2_rust](https://github.com/ros2-rust/ros2_rust) – Rust bindings for ROS 2 
...
- [lambdaclass/cairo-vm](https://github.com/lambdaclass/cairo-vm) – cairo-vm is a Rust implementation of the Cairo VM. Cairo (CPU Algebraic Intermediate Representation) is a programming language for writing provable programs, where one party can prove to another that a certain computation was executed correctly without the need for this party to re-execute the same program.
...
- [starcoinorg/starcoin](https://github.com/starcoinorg/starcoin) – Starcoin - A Move smart contract blockchain network that scales by layering
...
- [RustCrypto/elliptic-curves](https://github.com/RustCrypto/elliptic-curves) – Collection of pure Rust elliptic curve implementations: NIST P-224, P-256, P-384, secp256k1, SM2
...
- [delendum-xyz/zk-knowledge](https://github.com/delendum-xyz/zk-knowledge) – knowledge base of ZKP including applications, hardware, technical discussions and more. 
...
- [hecmas/pairing-playground](https://github.com/hecmas/pairing-playground)
...
- [informalsystems/apalache](https://github.com/informalsystems/apalache) – APALACHE: symbolic model checker for TLA+ and Quint
...
- [opengeos/python-geospatial](https://github.com/opengeos/python-geospatial) – A collection of Python packages for geospatial analysis with binder-ready notebook examples
- [slai-labs/get-beam](https://github.com/slai-labs/get-beam) – This is the home of the Beam CLI binaries, as well as a collection of example apps built with Beam
...
- [lambdaclass/mina_bridge](https://github.com/lambdaclass/mina_bridge) – Bridge from Mina to Ethereum
...
- [maple-labs/maple-core-v2](https://github.com/maple-labs/maple-core-v2)
- [hooperben/noir-hardhat-template](https://github.com/hooperben/noir-hardhat-template) – This is a repository intended to be a template repository for working with Noir and Hardhat (and foundry support if desired).
...
- [succinctlabs/telepathy-contracts](https://github.com/succinctlabs/telepathy-contracts) – Smart contracts for the Telepathy protocol
...
- [makerdao/multicall](https://github.com/makerdao/multicall) – Multicall: Aggregate multiple constant function call results into one
- [makerdao/dss](https://github.com/makerdao/dss) – Dai Stablecoin System
- [FraxFinance/frax-solidity](https://github.com/FraxFinance/frax-solidity) – Solidity implementation of the Frax Protocol
- [pickle-finance/protocol](https://github.com/pickle-finance/protocol) – Pickle Protocols
...
- [bitcoinwarrior1/learn-solidity-with-examples](https://github.com/bitcoinwarrior1/learn-solidity-with-examples) – A repo full of smart contracts written in solidity
...
- [orlenyslp/Caterpillar](https://github.com/orlenyslp/Caterpillar) – Caterpillar: A BPMN-based BPMS for Ethereum
...
- [zkp2p/zk-p2p](https://github.com/zkp2p/zk-p2p) – A trustless P2P fiat onramp powered by ZK proofs.
...
- [zama-ai/fhevm](https://github.com/zama-ai/fhevm) – A Solidity library for interacting with an fhEVM blockchain.
...
- [paulmillr/noble-bls12-381](https://github.com/paulmillr/noble-bls12-381) – DEPRECATED. Use noble-curves instead. Fastest JS implementation of BLS12-381.
- [paulmillr/scure-bip39](https://github.com/paulmillr/scure-bip39) – Secure, audited & minimal implementation of BIP39 mnemonic phrases
- [No-Trade-No-Life/Yuan](https://github.com/No-Trade-No-Life/Yuan) – Yuan -  Investment OS for everyone
...
- [Kryha/zk-states](https://github.com/Kryha/zk-states) – Verifiable state manager for React based on o1js & Mina protocol
...
- [ZenGo-X/binance-thresh-wallet](https://github.com/ZenGo-X/binance-thresh-wallet) – Wallet for Binance chain powered by two-party ECDSA
...
- [SyMind/stone-lang](https://github.com/SyMind/stone-lang) – TypeScript 实现《两周自制脚本语言》书中的 stone 语言。
...
- [renproject/bridge-v2](https://github.com/renproject/bridge-v2) – An easy way to bridge cross-chain assets between blockchains.
...
- [balancer/balancer-v2-monorepo](https://github.com/balancer/balancer-v2-monorepo) – Balancer V2 Monorepo
...
- [ribbon-finance/ribbon-v2](https://github.com/ribbon-finance/ribbon-v2) – Ribbon V2 for Theta Vaults
- [delvtech/elf-contracts](https://github.com/delvtech/elf-contracts) – Element Protocol Smart Contracts
...
- [nervosnetwork/muta-minits](https://github.com/nervosnetwork/muta-minits) – TypeScript to LLVM compiler
